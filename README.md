...
![Monte Carlo Distribution](screenshots/mc_distribution.png)

### Monte Carlo Spaghetti (downsampled paths)
![MC Spaghetti](screenshots/mc_spaghetti.png)

### Drawdown Stress Test
![Drawdown Stress Test](screenshots/drawdown_stress.png)

### Drawdown Density Heatmap
![Drawdown Heatmap](screenshots/drawdown_heatmap.png)
